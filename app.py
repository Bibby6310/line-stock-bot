...
from linebot.v3.messaging import (
    ...
    PushMessage, ReplyMessage, TextMessage
)
...
OPENAI_API_KEY = os.getenv("OPENAI_API_KEY", "")  # 選填，AI 問答用
...
# ============================================================
# AI 問答（接 OpenAI 或 Anthropic）
# ============================================================
def ask_ai(question: str) -> str:
    """AI 問答 - 可接 OpenAI 或 Anthropic"""
...
def handle_message(event):
    ...
    if reply:
        with ApiClient(configuration) as api_client:
            api = MessagingApi(api_client)
            api.reply_message(ReplyMessage(
